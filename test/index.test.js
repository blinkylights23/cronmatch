...
describe("The cron expression parser's", () => {
  ...
  describe('hours field', () => {
    it('should correctly parse * * * * *', () => {
      let cronExpr = '* * * * *'
      let date1 = new Date('January 20, 2020 02:00:00')
      let date2 = new Date('January 20, 2020 12:00:00')
      let date3 = new Date('January 20, 2020 18:00:00')
      expect(cronmatch(cronExpr, date1)).toBe(true)
      expect(cronmatch(cronExpr, date2)).toBe(true)
      expect(cronmatch(cronExpr, date3)).toBe(true)
    })
    ...
    it('should correctly parse * 03-15/2 * * * *', () => {
      let cronExpr = '* 03-15/2 * * * *'
      let date1 = new Date('January 20, 2020 01:00:00')
      let date2 = new Date('January 20, 2020 03:00:00')
      let date3 = new Date('January 20, 2020 04:00:00')
      let date4 = new Date('January 20, 2020 12:00:00')
      let date5 = new Date('January 20, 2020 13:00:00')
      let date6 = new Date('January 20, 2020 16:00:00')
      expect(cronmatch(cronExpr, date1)).toBe(false)
      expect(cronmatch(cronExpr, date2)).toBe(true)
      expect(cronmatch(cronExpr, date3)).toBe(false)
    ...
    it('should correctly parse * */3 * * *', () => {
      let cronExpr = '* */3 * * *'
      let date1 = new Date('January 20, 2020 11:00:00')
      let date2 = new Date('January 20, 2020 12:00:00')
      let date3 = new Date('January 20, 2020 13:00:00')
      let date4 = new Date('January 20, 2020 14:00:00')
      let date5 = new Date('January 20, 2020 15:00:00')
      let date6 = new Date('January 20, 2020 16:00:00')
      let date7 = new Date('January 20, 2020 17:00:00')
      expect(cronmatch(cronExpr, date1)).toBe(false)
      expect(cronmatch(cronExpr, date2)).toBe(true)
      expect(cronmatch(cronExpr, date3)).toBe(false)
      expect(cronmatch(cronExpr, date4)).toBe(false)
    ...
    it('should correctly parse * 0,3,18 * * *', () => {
      let cronExpr = '* 0,3,18 * * *'
      let date1 = new Date('January 20, 2020 00:00:00')
      let date2 = new Date('January 20, 2020 02:00:00')
      let date3 = new Date('January 20, 2020 03:00:00')
      let date4 = new Date('January 20, 2020 18:00:00')
      let date5 = new Date('January 20, 2020 22:00:00')
      expect(cronmatch(cronExpr, date1)).toBe(true)
      expect(cronmatch(cronExpr, date2)).toBe(false)
      expect(cronmatch(cronExpr, date3)).toBe(true)
      expect(cronmatch(cronExpr, date4)).toBe(true)
